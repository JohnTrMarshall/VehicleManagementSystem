...
{
    public partial class processTransaction_Form_Lease : Form
    {
        ...
        public processTransaction_Form_Lease(Vehicle vehicle, Employee employee, string process_str)
        {
            InitializeComponent();
            ...
            employeeName_textbox.Text = employee.userName;
        ...
        private void confirm_button_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Confirm Transaction?", "Confirm Transaction", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                using (SqlConnection connection = new SqlConnection(db.GetConnectionString()))
                {
                    ...
                    vehicle.returnDate = dateTimePicker1.Value;

                    this.Hide();

                    showTransaction_Form st_form = new showTransaction_Form(customer, vehicle, employee, process_textbox.Text);
                    st_form.Show();
                }
            } 
        }
