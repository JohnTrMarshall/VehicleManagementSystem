    ...
    public class Admin
    {
        ...
        public bool updateVehicleInfo(Vehicle vehicle)
        {
            ...
            try
            {
                ...
                string updateString = $"UPDATE Employee SET make = '{make}', model= '{model}', year= '{year}', color= '{color}', owner='{owner}', holder= '{holder}', returnDate= '{returnDate}', price= '{price}', mileage=' {mileage}' WHERE vim= '{vin}'";
